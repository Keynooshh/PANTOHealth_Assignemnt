...
let XrayController = class XrayController {
    constructor(xrayDataSerivce) {
        this.xrayDataSerivce = xrayDataSerivce;
    }
    getAllXray() {
...
], XrayController.prototype, "getAllXray", null);
__decorate([
    (0, common_1.Get)(':id'),
...
exports.XrayController = XrayController = __decorate([
    (0, common_1.Controller)('/v1/xray'),
